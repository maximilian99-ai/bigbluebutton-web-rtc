...
class LinkCopyButton extends BaseButton {
...
LinkCopyButton.propTypes = propTypes;
LinkCopyButton.defaultProps = defaultProps;


const LinkCopyComponent = styled(LinkCopyButton)`
