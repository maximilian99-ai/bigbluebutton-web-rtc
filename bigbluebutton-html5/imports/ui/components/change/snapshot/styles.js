...
import Styled from '../../common/button/styles';
import BaseButton from '../../common/button/base/component';
...
class SnapshotButton extends BaseButton {
...
SnapshotButton.propTypes = propTypes;
SnapshotButton.defaultProps = defaultProps;


const SlideSnapshotComponent = styled(SnapshotButton)`
  
`;

export default SlideSnapshotComponent;