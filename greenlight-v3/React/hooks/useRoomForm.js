...
export default function useRoomForm({ defaultValues: _defaultValues, ..._config } = {}) {
  ...
  const fields = useMemo(() => ({
    ...
    password: {
      label: t('forms.room.fields.password.label'),
      placeHolder: t('forms.room.fields.password.placeholder'),
      controlId: 'createRoleFormPassword',
      hookForm: {
        id: 'password'
      }
    },
    password_confirmation: {
      label: t('forms.room.fields.password_confirmation.label'),
      placeHolder: t('forms.room.fields.password_confirmation.placeholder'),
      controlId: 'createRoleFormPasswordConfirmation',
      hookForm: {
